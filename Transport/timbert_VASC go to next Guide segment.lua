-- @description VASC Go to next Guide segment
...
local function goToNextTake()     
  ...
  reaper.Main_OnCommand(40417, 0) -- Item: Select and move to next item
...
local function goToNextTakeRec()     
...
reaper.Undo_EndBlock("VASC Go to the next Guide segment", -1 ) -- End of the undo block. Leave it at the bottom of your main function.
