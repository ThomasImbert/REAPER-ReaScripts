...
local function InsertItemsInTable()
	...
	for i = 0, reaper.CountMediaItems(0) - 1 do
		if
			reaper.GetMediaItemInfo_Value(reaper.GetMediaItem(0, i), "D_POSITION") > currentContentEndPos
			and reaper.GetMediaItemInfo_Value(reaper.GetMediaItem(0, i), "C_LOCK") ~= 1
		then
