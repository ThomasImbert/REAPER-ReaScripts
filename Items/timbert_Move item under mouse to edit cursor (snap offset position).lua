-- @description Move item under mouse to edit cursor (snap offset position)
-- @author Thomas Imbert
-- @version 1.0
-- @about  
--      Move item under mouse to edit cursor (snap offset position)
-- @changelog
--   #Initial release
...
function main()
	...
	reaper.SetMediaItemInfo_Value(item, "D_POSITION",
		reaper.GetCursorPosition() - reaper.GetMediaItemInfo_Value(item, "D_SNAPOFFSET"))
end
