-- @description VASC Select and prepare Alt takes for rendering
...
-- settings
local validationTag = "Validated" -- can be set to "Uncertain" to grab all uncertain + Validated Alt takes
...
reaper.Undo_EndBlock('VASC Select and prepare Alt takes for rendering', 0)
