-- @description ASWG iXML Metadata Columns for VASC
-- @author Thomas Imbert
-- @version 1.0
-- @about
--      Create metadata columns for ASWG relevant to VASC tool in the Media explorer.
--
