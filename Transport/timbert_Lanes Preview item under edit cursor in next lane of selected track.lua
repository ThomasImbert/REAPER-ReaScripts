...
function main()
	...
	if laneIndex + 1 > lastLane or laneIndex > lastLane or laneIndex < laneIndexes[1]
		then laneIndex = laneIndexes[1]
		else laneIndex = laneIndexes[(timbert.FindIndex(laneIndexes,laneIndex))+1] -- goes to next lane with content
	end
