...
function main()
	...
	if laneIndex - 1 < laneIndexes[1] or laneIndex > lastLane
		then laneIndex = lastLane
		else laneIndex = laneIndexes[(timbert.FindIndex(laneIndexes,laneIndex))-1] -- goes to previous lane with content
	end
